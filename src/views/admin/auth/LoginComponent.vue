          ...
          <div class="card-group mb-0">
            <div class="card p-4">
              <div class="card-body">
                ...
                <form method="post" name="vks.loginForm" @submit.prevent="handleSubmit" novalidate>
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                      <router-link to="/forgot-password" class="btn btn-link px-0">Forgot password?</router-link>
...
export default {
  ...
  data: function() {
    ...
    return {
      vks: {
        login: {
          email: "vikas.ukani@dignizant.com",
          password: "vikas123"
          // email: null,
          // password: null
        }
